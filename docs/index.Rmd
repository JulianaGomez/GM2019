...
## Gimnasio Moderno vs. Grupos de referencia - Promedio
...
## GM vs.Top 10 calendario A - Ranking
...
## Calendario A - puesto lectura crítica
...
## Calendario A - puesto matemáticas
...
Dado que las pruebas de calendario A y B son diferentes, y por lo tanto, están en "rankings" diferentes, se comparará al Gimnasio Moderno contra los colegios de calendario B de acuerdo a su promedio en las pruebas. 

## Calendario B - promedio
...
## Calendario B - promedio lectura crítica
...
## Calendario B - promedio matemáticas
...
## Calendario B - promedio ciencias naturales
...
## Calendario B - promedio sociales
...
## Saber Pro Razonamiento Cuantitativo 
...
##Egresados de carreras, 2011-2018
...
##Egresados de universidades, 2011-2018
...
##Egresados de carreras, por universidad, 2011-2018
...
## Correlación notas internas inglés - Inglés Saber 11
...
soloingplot <- ggplot(soloing, aes(x=Inglés, y=SB11Ingles,color=Curso,label=Estudiante))+
  facet_wrap(~Curso)+
  geom_point()+
  theme_bw()+
  geom_smooth(method=lm)+
  labs(x="Notas finales inglés estandarizadas",y="Notas inglés SB 11 estandarizadas")+
...
## Correlación notas internas español - Lectura Crítica Saber 11
...
## Correlación notas internas Lectura Crítica 1 - Lectura Crítica Saber 11
...
## Correlación notas internas Lectura Crítica 2 - Lectura Crítica Saber 11
...
## Correlación notas internas Filosofía - Lectura Crítica Saber 11
...
## Correlación notas internas Sociales - Sociales Saber 11
...
## Correlación notas internas Física - Ciencias Naturales Saber 11
...
## Correlación notas internas Química - Ciencias Naturales Saber 11
...
## Correlación notas internas Biología - Ciencias Naturales Saber 11
...
## Correlación notas internas Cálculo - Matemáticas Saber 11
...
- Saber Pro: razomamiento cuantitativo por debajo del promdio.
